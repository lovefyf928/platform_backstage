<template>
    <div style="width: 980px">
        ...
        <div style="margin-top: 15px;background: #ffffff;padding-bottom: 45px">
            <div class="son">
                <div class="box">
                    <p>商家名称</p>
            ...
            <table class="tb">
                <tr style="font-weight: bold;font-size: 14px" align="center">
                    <td width="615" height="40">店铺信息</td>
                    <td width="145" height="40">店铺分类</td>
                    <td width="145" height="40">店铺等级</td>
                    <td width="74" height="40">操作</td>
                </tr>
                <tr v-for="(tmp,index) in alldata" align="center" class="dd">
                    <td>
                        ...
                        <p style="font-size:12px;width: 200px;height: 40px;float: left;text-align: left;line-height: 40px;text-indent: 5px">{{tmp.store_name}}</p>
                    </td>
                    ...
                    <td style="font-size:12px">
                        <span @click="update(index)" style="color: #41bbee">上传</span>
                    </td>
                </tr>
            </table>
            <div class="footer">
        ...
        methods: {
            update(index) {
                this.$axios.post("http://api.eawsp.com/api/index/addShopProduct?token="+sessionStorage.getItem("token"),{
                    ...
                    sort: JSON.stringify(this.$root.hotshopindex),
                    floor: "热门店铺"
                }).then((res) => {
                    console.log(res);
                    if (res.data.code == 0) {
